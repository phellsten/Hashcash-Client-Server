...
#include <netdb.h>
void domessage(char* msg, int sockfd);
int main(int argc, char**argv)
{
  ...
  //printf("%s\n", buffer);
	...
	domessage("SOLN 1fffffff 0000000019d6689c085ae165831e934ff763ae46a218a6c172b3f1b60a8ce26f 1000000023212147\r\n", sockfd);
	domessage("PING\r\n", sockfd);
	domessage("PONG\r\n", sockfd);
	domessage("SOLN 1fffffff 0000000019d6689c085ae165831e934ff763ae46a218a6c172b3f1b60a8ce26f 1000000023212605\r\n", sockfd);
	domessage("WORK 1fffffff 0000000019d6689c085ae165831e934ff763ae46a218a6c172b3f1b60a8ce26f 1000000023212399 01\r\n", sockfd);
